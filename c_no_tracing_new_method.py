...
while i < 100:
	...
	if i == 1:
		...
		while z < no_of_metrics:
			z += 1
			title_string = title_string + "Metric" + str(z) + ","
		z = 0
		while z < no_of_metrics:
			z += 1
			title_string = title_string + "Ceiling" + str(z) + ","
		z = 0
		while z < no_of_metrics:
			z += 1
			title_string = title_string + "Floor" + str(z) + ","
		z = 0
		while z < no_of_metrics:
			z += 1
			title_string = title_string + "CTriggered" + str(z) + ","
		z = 0
		while z < no_of_metrics:
			z += 1
			title_string = title_string + "FTriggered" + str(z) + ","
		z = 0
		while z < no_of_metrics:
			z += 1
			title_string = title_string + "ARIMAActionTaken" + str(z) + ","
		z = 0
		while z < no_of_metrics:
			z += 1
			title_string = title_string + "CORRActionTaken" + str(z) + ","
	...
	data_reading_string = ""
	while z < no_of_metrics:
		data_reading_string = data_reading_string + str(dataset_tuple[z][0]) + ","

	#f.write(str(dataset_cpu1[0]) + "," + str(dataset_ram1[0]) + "," + str(dataset_hdd1[0]) + ",")
	f.write(data_reading_string)
